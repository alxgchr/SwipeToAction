package com.example.swipetoaction.helper
...
abstract class MySwipeHelper(contex:Context, private val recyclerView: RecyclerView, internal var buttonWidth:Int): ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    private val onTouchListener = View.OnTouchListener{ _, motionEvent ->
        ...
        val swipepedItem = swipeViewHolder!!.itemView
        val rect = Rect()
        swipepedItem.getGlobalVisibleRect(rect)
    ...
    init {
        ...
        this.gestureDetector = GestureDetector(contex, gestureListener)
